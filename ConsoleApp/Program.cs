...
namespace ConsoleApp
{
    internal static class Program
    {
        ...
        {
            new Effect("Freeze", 1000, Effects.Freeze, 1),
            new Effect("Weakness", 1000, Effects.Weakness, 6),
            new Effect("Poison", 1000, Effects.Poison, 3),
        };
        ...
        private static List<Character> bosses = new List<Character>()
        {
            ...
            new Character(
                ...
                60,
                new Weapon("Blade of the Empire", 0, new CharacterStatistics() {Agility = 60}, WeaponType.Sword, 200, 800),
                new ArmourSet(
