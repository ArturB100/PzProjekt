...
namespace ConsoleApp
{
    internal static class Program
    {
        static List<Spell> spells = new List<Spell>
        {
            ...
            new Spell(1, "Molten Death", 423000, new CharacterStatistics() {Magica = 60}, Spells.MoltenDeath),
        };
        ...
        static List<Tournament> _tournaments = new List<Tournament>()
        {
        ...
        static void Main()
        {
            Character player = CharacterFactory.createRandomCharacterBasedOnLevel(50, swords, axes, helmets, chestplates, leggings, boots, spells);
            Character enemy = CharacterFactory.createRandomCharacterBasedOnLevel(60, swords, axes, helmets, chestplates, leggings, boots, spells);
            
            Console.WriteLine(player.Inventory.Weapon.Name);
            Console.WriteLine(player.Inventory.ArmourSet.Helmet.Name);
            Console.WriteLine(player.Inventory.ArmourSet.Chestplate.Name);
            Console.WriteLine(player.Inventory.ArmourSet.Leggings.Name);
            Console.WriteLine(player.Inventory.ArmourSet.Boots.Name);
            player.Inventory.AvailableSpells.ForEach(spell => Console.WriteLine(spell.Name));

            Console.WriteLine(enemy.Inventory.Weapon.Name);
            Console.WriteLine(enemy.Inventory.ArmourSet.Helmet.Name);
            Console.WriteLine(enemy.Inventory.ArmourSet.Chestplate.Name);
            Console.WriteLine(enemy.Inventory.ArmourSet.Leggings.Name);
            Console.WriteLine(enemy.Inventory.ArmourSet.Boots.Name);
            enemy.Inventory.AvailableSpells.ForEach(spell => Console.WriteLine(spell.Name));
